...
Поток веток и правило повышения версии зафиксированы двумя принятыми
(`maintained`) стандартами:
...
изменения PATCH-класса. Kernel в `0.x`: `0.1.0` и последующие остаются
draft-релизами в смысле `COMPATIBILITY.md`.
