...
//! `meridian_app::operating_model::execution_state`, reading through
...
//! place the `execution-state-model: ` presentation prefix is applied.

use std::path::Path;

use meridian_app::operating_model::execution_state as app;

use super::{split_diagnostics, with_family_prefix};
use crate::adapters::workspace_reader::FsWorkspaceReader;

const FAMILY: &str = "execution-state-model";
