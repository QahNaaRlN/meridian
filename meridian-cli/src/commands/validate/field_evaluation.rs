...
//! `meridian_app::operating_model::field_evaluation`, reading through
...
//! place the `meridian-field-evaluation: ` presentation prefix is applied.

use std::path::Path;

use meridian_app::operating_model::field_evaluation as app;

use super::{split_diagnostics, with_family_prefix};
use crate::adapters::workspace_reader::FsWorkspaceReader;

const FAMILY: &str = "meridian-field-evaluation";
