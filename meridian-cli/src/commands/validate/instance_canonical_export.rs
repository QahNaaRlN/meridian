...
//! `meridian_app::operating_model::instance_canonical_export`, reading through
...
//! place the `instance-canonical-export: ` presentation prefix is applied.

use std::path::Path;

use meridian_app::operating_model::instance_canonical_export as app;

use super::{split_diagnostics, with_family_prefix};
use crate::adapters::workspace_reader::FsWorkspaceReader;

const FAMILY: &str = "instance-canonical-export";
