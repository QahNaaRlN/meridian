...
//! `meridian_app::operating_model::instance_data_migration`, reading through
...
//! place the `instance-data-migration: ` presentation prefix is applied.

use std::path::Path;

use meridian_app::operating_model::instance_data_migration as app;

use super::{split_diagnostics, with_family_prefix};
use crate::adapters::workspace_reader::FsWorkspaceReader;

const FAMILY: &str = "instance-data-migration";
