...
//! `meridian_app::operating_model::workspace_compatibility_qualification`, reading through
...
//! (`rust-architecture-conformance-7`).
//!
//! Every message [`app::evaluate`] produces is prefix-free; this is the ONE
//! place the `workspace-compatibility-qualification: ` presentation prefix is applied.

use std::path::Path;

use meridian_app::operating_model::workspace_compatibility_qualification as app;

use super::{split_diagnostics, with_family_prefix};
use crate::adapters::workspace_reader::FsWorkspaceReader;

const FAMILY: &str = "workspace-compatibility-qualification";
