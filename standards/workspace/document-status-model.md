...
`contract`, `protocol`, `template`, `reference` и `changelog` — живые
...
нет в §12; заведённая ради симметрии, она означала бы пять почти одинаковых
таблиц и пять мест для расхождения.
