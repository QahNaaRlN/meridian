...
When publishing, use the ADR body template of the canonical wiki's profile — currently `../templates/ADR.confluence-template.md`: do not copy the local H1, and render visible metadata through the unified bilingual table.
